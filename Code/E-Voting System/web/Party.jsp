...
#abstract
{
    ...
    <body>
        ...
        <div id="abstract">
            <img src="images/voter.png" align="right" width="350px" height="250px" style="margin-top:50px;">
            <h2><center>Party Login</center></h2>
            ...
            <form name="login" action="PartyLogin.jsp" method="post">

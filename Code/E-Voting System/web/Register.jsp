...
#abstract
{
    ...
    <body>
        ...
        <div id="abstract">
            <img src="images/register.png" align="right" width="300px" height="350px" style="margin-top:50px;">
            <h2><center>Voter Registration Form</center></h2>
    ...
    String useridds ="VOTE_"+String.valueOf(rand.nextInt(10))+String.valueOf(rand.nextInt(10))+String.valueOf(rand.nextInt(10)
...
%>
            <form name="login" action="VoterRegister" method="post" enctype="multipart/form-data">
            <table width="350px" height="550px" style="margin-left:200px;">
                <div id="selection">
                    <tr><td>Select State</td><td><select name="state" id="listBox" onchange='selct_district(this.value)'></select></td></tr>
                    <tr><td>Select District</td><td><select name="district" id='secondlist'></select></td></tr>
      </div>
                <tr><td>Voter Id</td><td><input type="text" name="vid"  value="<%=useridds%>"></td></tr>
                ...
                <tr><td>Mobile</td><td><select name="gender">

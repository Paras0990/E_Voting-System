...
<%
    ...
    try
    {
      ...
      ResultSet rs=st.executeQuery("select * from candidate where username='"+username+"' and password='"+password+"' ");
      while(rs.next())
      {
       ...
       <script type="text/javascript">
           ...
           window.location="CandidateHome.jsp";
...
%>
       <script type="text/javascript">
           window.alert("Admin Not Yet Activated In Activated your Account");
